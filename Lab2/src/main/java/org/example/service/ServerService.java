 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:8080/Server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://example.org/", "ServerService");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://example.org/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/", "ServerPort"), Server.class, features);
    }
